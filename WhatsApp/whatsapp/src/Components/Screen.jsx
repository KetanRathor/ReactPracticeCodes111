    ...
    >
      ...
      >
        ...
        <Box sx={{ textAlign: "center" }}>
          <Box>
            <Typography
              sx={{ fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif",letterSpacing: "-0.5px",fontSize: "31px", color: grey[300], paddingTop: "25px",lineHeight: "1.4", // Adjust line height
              fontWeight: "lighter", }}
            >
